...
class Agent(object):
    ...
    def LSPI(self):
        ...
        for i in range(self.num_iterations):
            ...
            X, r_sample = self.sampling(old_w,num_sampling=self.num_sampling)
            w = np.linalg.inv(X.T*X+II)*X.T*r_sample
#            print 'original'
#            print X.T*X+II
#            print 'inverse'
#            print np.linalg.inv(X.T*X+II)
#            print np.linalg.matrix_rank(X.T*X+II)
